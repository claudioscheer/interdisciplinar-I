...
======
O projeto foi batizado de Secretum, e consistiu na criação de um chat utilizando-se a criptografia baseada em cálculos com matrizes. Dentro da pasta `outros` é possível visualizar o [relatório](http://pastebin.com/10hzCYJa) desenvolvido no semestre e uma calculadora de matrizes desenvolvida pelo grupo. Já na pasta `Secretum` tem o código fonte do chat desenvolvido.
